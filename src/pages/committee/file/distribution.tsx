...
const CommitteeFileDistribution: PageFC = () => {
...
CommitteeFileDistribution.layout = "committee"
CommitteeFileDistribution.rbpac = {
  type: "higherThanIncluding",
  role: "committee",
}

export default CommitteeFileDistribution
