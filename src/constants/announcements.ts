...
export const announcements: Announcement[] = [
  ...
  {
    id: "6c4f2346-44b9-45e9-bb60-985cf4f39aa7",
    date: dayjs.tz("2021-08-17T19:30:00", "Asia/Tokyo"),
    title: "【重要】事前収録日における教室貸出の中止について(一般企画)",
    text: [
      "学実委では希望する一般企画に対して事前収録日（9月21, 22, 24日）に教室を貸し出す予定で準備を進めてまいりましたが、昨今の深刻な感染状況、ならびに緊急事態宣言の発令を鑑み、事前収録日における教室貸出を中止することといたしました。",
      "事前収録日における教室の利用を行う予定であった企画につきましては、自宅等での収録に変更していただきますようお願いいたします。なお、現在学実委では、学園祭に関係する活動につきまして、同居人以外と同じ場所で行うことを禁止しておりますのでご承知おきください。",
      "本規制により企画内容の変更が必要となる企画におかれましては、雙峰祭オンラインシステムの「企画内容変更フォーム」にご回答いただくことにより企画内容の変更を承ります。",
      "急なお願いとなり皆様には多大なるご迷惑をおかけいたしますことを深くお詫び申し上げます。",
    ].join("\n"),
  },
]
/**
